...
class ListviewItemWidget extends StatelessWidget {
  ...
  var controller = Get.find<Three4Controller>();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Obx(
                                        () => Text(
                                          listviewItemModelObj.two!.value,
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Obx(
                              () => Text(
                                listviewItemModelObj.six!.value,
                                style: theme.textTheme.headlineMedium,
                              ),
                            ),
                            Obx(
                              () => CustomImageView(
                                imagePath: listviewItemModelObj.two1!.value,
                                height: 16.h,
                                width: 14.h,
                                alignment: Alignment.bottomCenter,
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            Obx(
                              () => CustomImageView(
                                imagePath: listviewItemModelObj.one2!.value,
                                height: 40.h,
                                width: 42.h,
                                margin: EdgeInsets.only(left: 8.h),
                              ),
