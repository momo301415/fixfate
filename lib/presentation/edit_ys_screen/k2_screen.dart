                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Obx(()=> Text("${controller.kcalData.value}",
                              ...
                              ListView.builder(
                                ...
                                itemBuilder:(context, index) {
                                    return _buildCarbohydratesRow(controller.typeListData[index]);
                                  },
                              ),
                        ...
                        TextButton(
                            ...
                            child: Text("lbl50".tr, style: CustomTextStyles.titleMediumBluegray400,)
                        )
                      ],
                    ),
                  ),
          ...
          Expanded(child: InkWell(
            ...
            child: Container(
              ...
              child:  Row(
                ...
                children: [
                  Obx(()=>Text("${controller.kcalData.value ?? "lbl348".tr}",
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child:  Row(
          mainAxisAlignment: MainAxisAlignment.start,
          children: [
            Obx(()=>Text("${controller.typeData.value ?? "lbl348".tr}",
