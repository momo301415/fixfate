...
import 'initial_tab2_page.dart'; // ignore_for_file: must_be_immutable

class K81Screen extends GetWidget<K81Controller> {
  const K81Screen({Key? key})
      : super(
          key: key,
        );
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  CustomImageView(
                                    imagePath: ImageConstant.img16x12,
                                    height: 16.h,
                                    width: 14.h,
