  ...
  Widget _buildBodyInfoSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("lbl423".tr, style: CustomTextStyles.bodySmallBluegray900W),
          SizedBox(height: 8.h),
          CustomTextFormField(
            readOnly: true,
          ...
          Text("lbl78".tr, style: CustomTextStyles.bodySmallBluegray900W),
          SizedBox(height: 8.h),
          CustomTextFormField(
            readOnly: true,
          ...
          SizedBox(height: 24.h),
          Text("lbl80".tr, style: CustomTextStyles.bodySmallBluegray900W),
          SizedBox(height: 8.h),
          ...
          SizedBox(height: 24.h),
          Text("lbl79".tr, style: CustomTextStyles.bodySmallBluegray900W),
          SizedBox(height: 8.h),
          InkWell(
