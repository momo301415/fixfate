...
/// 健康-壓力頁面
class K80Page extends GetWidget<K80Controller> {
  const K80Page({Key? key}) : super(key: key);
        ...
        return Column(
          ...
          children: [
                  ...
                  children: [
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text: controller.pressureVal.value,
            ...
            Row(
              ...
              children: [
                buildLegendItem('輕鬆 1 ~ 30'),
                buildLegendItem('正常 31 ~ 70'),
                buildLegendItem('緊繃 71 ~ 100'),
              ],
            )
          ],
        );
  ...
  Widget buildLegendItem(String text) {
    return Row(
      children: [
        Container(
          width: 8,
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                      child: buildStat(
                          '${controller.lowMinCount.value}', '', 'lbl237'.tr)),
                ],
              ),
            ],
          ),
  ...
  Widget buildRecordList() {
    return Obx(() {
      ...
      final list = isRecordMode
          ? controller.k80ModelObj.value.listItemList.value
          : controller.k80ModelObj.value.listItemList2.value;
