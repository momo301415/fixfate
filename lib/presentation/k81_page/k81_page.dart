...
/// 健康-步數頁面
class K81Page extends GetWidget<K81Controller> {
  const K81Page({Key? key}) : super(key: key);
  ...
  Widget buildAnalysis() {
    return Padding(
      ...
      child: Obx(() {
        final list = controller.k81ModelObj.value.listItemList2.value;
