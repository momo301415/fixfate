...
class K83Controller extends GetxController with WidgetsBindingObserver {
  ...
  void clearData() {
    ...
    k83ModelObj.value.listItemList2.refresh();
  }

  /// 記錄頁面訪問事件
  void _logPageViewEvent() {
    FirebaseAnalyticsService.instance.logViewCaloriesPage(
      caloriesValue: caloriesVal.value.isNotEmpty ? caloriesVal.value : null,
      parameters: {
