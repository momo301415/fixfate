...
/// 健康-卡路里頁面
class K83Page extends GetWidget<K83Controller> {
  const K83Page({Key? key}) : super(key: key);
                  ...
                  children: [
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text: controller.caloriesVal.value,
  ...
  Widget buildAnalysis() {
    return Padding(
      ...
      child: Obx(() {
        final list = controller.k83ModelObj.value.listItemList2.value;
