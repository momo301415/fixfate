...
class CustomTextStyles {
  ...
  static TextStyle get pingFangTC3Primary => TextStyle(
        color: theme.colorScheme.primary.withValues(alpha: 0.8),
        fontSize: 6.fSize,
  ...
  static TextStyle get pingFangTC4ErrorContainerRegular => TextStyle(
  ...
  static TextStyle get pingFangTC4ErrorContainer => TextStyle(
        color: theme.colorScheme.errorContainer,
        fontSize: 7.fSize,
        fontWeight: FontWeight.w500,
      ).pingFangTC4;
  static TextStyle get pingFangTC4ErrorContainerRegular6 => TextStyle(
        color: theme.colorScheme.errorContainer,
        fontSize: 6.fSize,
        fontWeight: FontWeight.w400,
      ).pingFangTC4;
  ...
  static TextStyle get bodyMediumPrimaryContainer_3 =>
      theme.textTheme.bodyMedium!
          .copyWith(color: theme.colorScheme.primaryContainer);
  static TextStyle get bodySmallBluegray900W =>
